...
import fr.mycompany.travelapp.data.service.OnImageFetchedCallback;
import fr.mycompany.travelapp.data.service.RetrofitClient;
import fr.mycompany.travelapp.data.model.Hotel;
import fr.mycompany.travelapp.data.service.RetrofitClient2;
import fr.mycompany.travelapp.data.service.UnsplashApi;
            ...
            public void onResponse(@NonNull Call<HotelsResponse> call, @NonNull Response<HotelsResponse> response) {
                if (response.isSuccessful() && response.body()!=null){
                    ...
                    for (Hotel hotel : hotels) {
                        ...
                        fetchImageForLieu(query, 30, 1, CLIENT_ID, new OnImageFetchedCallback() {
                            @Override
